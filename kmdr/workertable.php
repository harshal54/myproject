    ...
    <!-- Right Sidebar End -->      
        ...
        <div class="content-page">
          ...
          <div class="widget-header transparent">
             <h3><strong style="position:relative;bottom:15px">EMPLOYEE LIST</strong></h3>
               <h5><a href="workersignup.php" class="btn btn-default" > Add EMPLOYEE</a></h5>
            </div>
                         ...
                         if($data)
                         {
                            ...
                            ?>
                              ...
                              <tr>
                                ...
                                <td><a href="workerprofile.php?id=<?php echo $d['id'];?>" class="fa fa-edit"></a></td>
                                <td><a onclick="deleteWorker('<?php echo $d['id'];?>');" class="fa fa-trash"></a></td>
