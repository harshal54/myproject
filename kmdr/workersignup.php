    ...
    <!-- Right Sidebar End -->      
        ...
        <div class="content-page">
          ...
          <!--  __________table start_____________ -->
             ...
             <h3><strong style="position:relative;bottom:10px;left:450px">ADD WORKER</strong></h3></div>
        <div>
                      ...
                      <div class="widget-content padding"> 
                                  <div  class='row'>
                                    <div class="col-sm-5">
                                        <label>Mobile No</label>
                                           <input type="text" class="form-control" onkeypress="event" maxlength="10" minlength="10"  name="mobile_no" >                       
                                      </div>
                                      <div class="col-sm-5">
                        ...
                        <br>
                        <div >    <input type="submit"  name="save" value="save" class="btn btn-success" style="margin-left: 300px">  </div>
                     </div>
                    </div></form>
                                    <?php
                                 ...
                                 if(isset($_REQUEST['save']))
                                 {
                                    ...
                                    $obj->insertWorkerData($full_name,$user_name,$mobile_no,$password,$date_time);
