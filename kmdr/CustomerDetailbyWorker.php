    ...
    <!-- Right Sidebar End -->      
        ...
        <div class="content-page">
          ...
          <div class="widget-header transparent">
             <h3><strong style="position:relative;bottom:15px">Employee Wise Customer</strong></h3>
                         ...
                         if($data)
                         {
                            ...
                            ?>
                              <tr>
                                ...
                                <th><?php echo $d['total_worker'];?></th>
                                <td><a href="workerdetails.php?id=<?php echo $d['id'];?>" class="btn btn-success">view</a></td>
