    ...
    <!-- Right Sidebar End -->      
        ...
        <div class="content-page">
          ...
          <!--  __________table start_____________ -->
             <h3><strong style="position:relative;bottom:5px">CUSTOMER TABLE</strong></h3>
            <div style="position:relative;bottom:30px; "><a href="customerfields.php" class="fa fa-print" style="margin-left: 900px"> GENETARE LIST</a></div>

             <div style="position:relative;bottom:10px;">
             <input type='text' id='name' placeholder="Search By Name" style="width:300px">
             <input type='text' id='mobile' placeholder="Search By Mobile" style="width:300px;margin-left:20px">
             <input type='text' id='adhar' placeholder="Search By Adhar No." style="width:300px;margin-left:20px">
              <button onclick='getName()' class="btn btn-success" style="margin-left:20px;">Search</button></div>
            ...
            <script>
             function getName()
             {
              ...
              if(name.length=='' && mobile.length=='' && adhar.length=='')
              {
              ...
              else
              {
                ...
                req.open("GET","ajax.php?name="+name+"&mobile="+mobile+"&adhar="+adhar,true);
                req.send();
                            ...
                            ?>
                              ...
                              <tr>
                                ...
                                <td><a href="costumerprofile.php?id=<?php echo $d['id'];?>" class="fa fa-eye"></a></td>
                                 <td><a onclick="deletecustomer('<?php echo $d["id"];?>');" class="fa fa-trash"></a></td>
