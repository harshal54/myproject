...
<!-- Mirrored from codervent.com/bulona/demo/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 07 Feb 2019 06:53:34 GMT -->
<head>
  <meta charset="utf-8"/>
   ...
   <div class="user-details">
    <div class="media align-items-center user-pointer collapsed" data-toggle="collapse" data-target="#user-dropdown">
     ...
     <div id="user-dropdown" class="collapse">
      ...
      <li><a href="<?php echo base_url();?>logoutcheck"><i class="icon-power"></i> Logout</a></li>
      </ul>
     </div>
      </div>
   <ul class="sidebar-menu do-nicescrol">
      ...
      <li>
        <a href="javaScript:void();" class="waves-effect">
          ...
          <span>Manage Seller</span> <i class="fa fa-angle-left pull-right"></i>
        </a>
        <ul class="sidebar-submenu">
    <li><a href='<?php echo base_url();?>Seller'><i class="zmdi zmdi-long-arrow-right"></i> Add Seller</a></li>
        <li><a href='<?php echo base_url();?>Seller/sellerlist'><i class="zmdi zmdi-long-arrow-right"></i> Seller List</a></li>
        </ul>
      </li>
      <li>
        <a href="javaScript:void();" class="waves-effect">
        ...
        <ul class="list-group list-group-flush">
         <li class="list-group-item d-flex justify-content-between align-items-center">
          ...
          <a href="javaScript:void();">
           <div class="media">
             <div class="avatar"><img class="align-self-start mr-3" src="<?php echo base_url();?>assets/images/avatars/avatar-5.png" alt="user avatar"></div>
            <div class="media-body">
          ...
          <a href="javaScript:void();">
           <div class="media">
             <div class="avatar"><img class="align-self-start mr-3" src="<?php echo base_url();?>assets/images/avatars/avatar-6.png" alt="user avatar"></div>
            <div class="media-body">
          ...
          <a href="javaScript:void();">
           <div class="media">
             <div class="avatar"><img class="align-self-start mr-3" src="<?php echo base_url();?>assets/images/avatars/avatar-8.png" alt="user avatar"></div>
            <div class="media-body">
